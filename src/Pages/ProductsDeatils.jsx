...
export default function ProductsDeatils() {
  ...
  const ProductData = async () => {
    try {
      const res = await fetch(
        `${import.meta.env.VITE_REACT_APP_BACKEND}/api/admin/Products/${id}`,
        {
          method: "GET",
          headers: {
  ...
  const CartCheck = async () => {
    if (check !== "true") {
      try {
        ...
        let price = showprice;
        const res = await fetch(
          `${import.meta.env.VITE_REACT_APP_BACKEND}/api/Wishlist/add`,
          {
            method: "POST",
            headers: {
              Accept: "application/json",
  ...
  const CheckWish = async () => {
    try {
      const res = await fetch(
        `${import.meta.env.VITE_REACT_APP_BACKEND}/api/Wishlist/check`,
        {
          method: "POST",
          headers: {
            Accept: "application/json",
  ...
  const addToCart = async () => {
    if (showSize !== "") {
      const res = await fetch(
        `${import.meta.env.VITE_REACT_APP_BACKEND}/api/Shoping/add`,
        {
          method: "POST",
          headers: {
            Accept: "application/json",
